...
// The active page is now located at /src/app/doctor/ai-customization/page.tsx.
export default function DeprecatedAiCustomizationPage() {
  return (
    <div>

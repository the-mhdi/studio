...
// The active page is now located at /src/app/doctor/patients/[patientId]/page.tsx.
export default function DeprecatedPatientProfilePage() {
  return (
    <div>
      ...
      <p>
        ...
        from /doctor/patients/[patientId].
      </p>
    </div>
  );
}
